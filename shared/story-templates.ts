...
export function generateStory(story: InsertStory): string {
    try {
        console.log('Starting story generation with params:', {
...
शुभ रात्रि, उदार। याद रखो कि {name} की तरह, दूसरों के साथ अपनी चीजें साझा करने से दुनिया सभी के लिए एक बेहतर जगह बनती है।`,
        ...
        console.log('Looking for templates for theme:', story.theme);
        ...
        console.log('Selecting template from available options');
        const template = allTemplates[Math.floor(Math.random() * allTemplates.length)];
        console.log('Using language:', story.language);
